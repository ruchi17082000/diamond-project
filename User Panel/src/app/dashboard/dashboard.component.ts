...
export class DashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  Inplay() {
    ...
    console.log("Inplay Request Data:", data); // Log the emitted data
    ...
    this.socket.on(
      ...
      function (data: any) {
        console.log("Inplay Response Data:", data); // Log the response data
        ...
        if (data) {
          ...
          console.log("Inplay Cricket Data:", this.cricketData); // Log cricket data
          console.log("Inplay Soccer Data:", this.soccerData);   // Log soccer data
          console.log("Inplay Tennis Data:", this.tennisData);   // Log tennis data
  ...
  homeSoc() {
    ...
    console.log("HomeSoc Request Data:", data); // Log the emitted data
    ...
    this.socket.on(
      ...
      function (data: any) {
        console.log("HomeSoc Response Data:", data); // Log the response data
        ...
        if (data) {
          ...
          console.log("HomeSoc Cricket Data:", this.cricketData); // Log cricket data
          console.log("HomeSoc Soccer Data:", this.soccerData);   // Log soccer data
          console.log("HomeSoc Tennis Data:", this.tennisData);   // Log tennis data
  ...
  homeFreeSoc() {
    ...
    console.log("HomeFreeSoc Request Data:", data); // Log the emitted data
    ...
    this.socket.on(
      ...
      function (data: any) {
        console.log("HomeFreeSoc Response Data:", data); // Log the response data
        ...
        if (data) {
          ...
          console.log("HomeFreeSoc Cricket Data:", this.cricketData); // Log cricket data
          console.log("HomeFreeSoc Soccer Data:", this.soccerData);   // Log soccer data
          console.log("HomeFreeSoc Tennis Data:", this.tennisData);   // Log tennis data
        }
      }.bind(this)
    );
  }
